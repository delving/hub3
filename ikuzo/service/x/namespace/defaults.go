...
var customNS = map[string]string{
	...
	"k3direct":    "http://gebouwen.brabantcloud.nl/prop/direct/",
	"k3prop":      "http://gebouwen.brabantcloud.nl/prop/",
	"k3statement": "http://gebouwen.brabantcloud.nl/prop/statement/",
	"k3value":     "http://gebouwen.brabantcloud.nl/prop/statement/value/",
	"k3ref":       "http://gebouwen.brabantcloud.nl/prop/reference/",
	"k3qual":      "http://gebouwen.brabantcloud.nl/prop/qualifier/",
}
...
var defaultNS = map[string]string{
	...
	"dbprop":     "http://orda-sosat.com/property/",
	...
	"leak":       "http://data.ontotext.com/resource/leaks#",
