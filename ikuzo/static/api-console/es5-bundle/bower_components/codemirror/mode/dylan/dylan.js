...
mod(CodeMirror)})(function(CodeMirror){"use strict";function forEach(arr,f){for(var i=0;i<arr.length;i++){f(arr[i],i)}}function some(arr,f){for(var i=0;i<arr.length;i++){if(f(arr[i],i))return!0/* ignoreName */ /* skipSlots */}return(/* ignoreName */ /* eat */!1/* skipSlots */ /* skipSlots */)}CodeMirror.defineMode("dylan",function(_config){// Words
