...
mod(CodeMirror)})(function(CodeMirror){"use strict";CodeMirror.defineMode("toml",function(){return{startState:function startState(){return{inString:/* ignoreName */ /* ignoreName */ /* eat */!1/* skipSlots */ /* skipSlots */,stringType:"",lhs:!0/* skipSlots */,inArray:0}},token:function token(stream,state){//check for state changes
