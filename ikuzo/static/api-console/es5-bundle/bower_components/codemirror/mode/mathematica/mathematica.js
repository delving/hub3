...
if(stream.match(reBaseForm,!0/* ignoreName */ /* skipSlots */,/* ignoreName */ /* eat */!1/* skipSlots */ /* skipSlots */)){return"number"}// Mathematica numbers. Floats (1.2, .2, 1.) can have optionally a precision (`float) or an accuracy definition
