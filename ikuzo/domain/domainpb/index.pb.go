...
const file_ikuzo_domain_domainpb_index_proto_rawDesc = "" +
	"\n" +
	"!ikuzo/domain/domainpb/index.proto\x12\bdomainpb\"\xd9\x02\n" +
	"\fIndexMessage\x12&\n" +
	"\x0eOrganisationID\x18\x01 \x01(\tR\x0eOrganisationID\x12\x1c\n" +
	"\tDatasetID\x18\x02 \x01(\tR\tDatasetID\x12\x1a\n" +
	"\bRecordID\x18\x03 \x01(\tR\bRecordID\x12\x1c\n" +
	"\tIndexName\x18\x04 \x01(\tR\tIndexName\x12\x18\n" +
	"\aDeleted\x18\x05 \x01(\bR\aDeleted\x12.\n" +
	"\bRevision\x18\x06 \x01(\v2\x12.domainpb.RevisionR\bRevision\x12\x16\n" +
	"\x06Source\x18\a \x01(\fR\x06Source\x124\n" +
	"\n" +
	"ActionType\x18\b \x01(\x0e2\x14.domainpb.ActionTypeR\n" +
	"ActionType\x121\n" +
	"\tIndexType\x18\t \x01(\x0e2\x13.domainpb.IndexTypeR\tIndexType\"b\n" +
	"\bRevision\x12\x10\n" +
	"\x03SHA\x18\x01 \x01(\tR\x03SHA\x12\x12\n" +
	"\x04Path\x18\x02 \x01(\tR\x04Path\x12\x16\n" +
	"\x06Number\x18\x03 \x01(\x05R\x06Number\x12\x18\n" +
	"\aGroupID\x18\x04 \x01(\tR\aGroupID*C\n" +
	"\n" +
	"ActionType\x12\x10\n" +
	"\fMODIFY_INDEX\x10\x00\x12\x10\n" +
	"\fDROP_ORPHANS\x10\x01\x12\x11\n" +
	"\rDELETE_RECORD\x10\x02*L\n" +
	"\tIndexType\x12\x06\n" +
	"\x02V2\x10\x00\x12\x06\n" +
	"\x02V1\x10\x01\x12\r\n" +
	"\tFRAGMENTS\x10\x02\x12\x13\n" +
	"\x0fDIGITAL_OBJECTS\x10\x03\x12\v\n" +
	"\aSUGGEST\x10\x04B\x17Z\x15ikuzo/domain/domainpbb\x06proto3"

var (
	file_ikuzo_domain_domainpb_index_proto_rawDescOnce sync.Once
	file_ikuzo_domain_domainpb_index_proto_rawDescData []byte
)

func file_ikuzo_domain_domainpb_index_proto_rawDescGZIP() []byte {
	file_ikuzo_domain_domainpb_index_proto_rawDescOnce.Do(func() {
		file_ikuzo_domain_domainpb_index_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ikuzo_domain_domainpb_index_proto_rawDesc), len(file_ikuzo_domain_domainpb_index_proto_rawDesc)))
	})
...
var file_ikuzo_domain_domainpb_index_proto_goTypes = []any{
...
func file_ikuzo_domain_domainpb_index_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ikuzo_domain_domainpb_index_proto_rawDesc), len(file_ikuzo_domain_domainpb_index_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
