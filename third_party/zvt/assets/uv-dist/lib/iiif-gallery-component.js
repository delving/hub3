    ...
    var GalleryComponent = /** @class */ (function (_super) {
        ...
        GalleryComponent.prototype.data = function () {
            return {
                ...
                content: {
                    searchResult: "{0} searchTerm result",
                    searchResults: "{0} searchTerm results",
                    select: "Select",
        ...
        GalleryComponent.prototype._sizeThumb = function ($thumb) {
            ...
            // if searchTerm results are visible, size index/label to accommodate it.
            // if the resulting size is below options.minLabelWidth, hide searchTerm results.
            if (this.options.data.searchResults && this.options.data.searchResults.length) {
                $searchResults.show();
