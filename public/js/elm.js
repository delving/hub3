...
var _delving$rapid$Charts$chartDefinition = function () {
	var text = F2(
...
var _delving$rapid$Charts$createDefinitions = {
	ctor: '::',
	_0: A2(
	...
	_1: {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _delving$rapid$Charts$chartDefinition,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	}
};
var _delving$rapid$Charts$graph = function (color) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
...
var _delving$rapid$Charts$pieChart = F2(
...
var _delving$rapid$Types$User = function (a) {
	return {name: a};
};
var _delving$rapid$Types$Service = function (a) {
	return {name: a};
};

var _delving$rapid$Msg$ViewSourceClick = function (a) {
	return {ctor: 'ViewSourceClick', _0: a};
};
var _delving$rapid$Msg$SelectMail = function (a) {
	return {ctor: 'SelectMail', _0: a};
};
var _delving$rapid$Msg$Toggle = function (a) {
	return {ctor: 'Toggle', _0: a};
};
var _delving$rapid$Msg$GotUsers = function (a) {
	return {ctor: 'GotUsers', _0: a};
};
var _delving$rapid$Msg$NewUrl = function (a) {
	return {ctor: 'NewUrl', _0: a};
};
var _delving$rapid$Msg$NavigateTo = function (a) {
	return {ctor: 'NavigateTo', _0: a};
};
var _delving$rapid$Msg$Snackbar = function (a) {
	return {ctor: 'Snackbar', _0: a};
};
var _delving$rapid$Msg$Mdl = function (a) {
...
var _delving$rapid$Route$urlFor = function (loc) {
	var _p0 = loc;
	switch (_p0.ctor) {
		case 'Home':
			return '#';
...
var _delving$rapid$Route$init = function (location) {
	var _p1 = location;
	if (_p1.ctor === 'Nothing') {
		return {
			ctor: '::',
			_0: _elm_lang$core$Maybe$Just(_delving$rapid$Route$Services),
			_1: {ctor: '[]'}
		};
	} else {
		return {
...
var _delving$rapid$Route$Users = {ctor: 'Users'};
var _delving$rapid$Route$Home = {ctor: 'Home'};
var _delving$rapid$Route$pathParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _delving$rapid$Route$Home, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_delving$rapid$Route$Users,
				_evancz$url_parser$UrlParser$s('users')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_delving$rapid$Route$Services,
					_evancz$url_parser$UrlParser$s('services')),
				_1: {ctor: '[]'}
			}
		}
	});
...
var _delving$rapid$Model$mockUsers = {ctor: '[]'};
var _delving$rapid$Model$initialModel = function (location) {
	return {
		mdl: _debois$elm_mdl$Material$model,
		snackbar: _debois$elm_mdl$Material_Snackbar$model,
		history: _delving$rapid$Route$init(location),
		users: _delving$rapid$Model$mockUsers,
		services: _delving$rapid$Model$mockServices,
		toggles: _elm_lang$core$Dict$empty,
		selectedMail: 'orgID 0'
	};
};
var _delving$rapid$Model$init = function (location) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_delving$rapid$Model$initialModel(
			_delving$rapid$Route$locFor(location)),
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material$init(_delving$rapid$Msg$Mdl),
			_1: {ctor: '[]'}
		});
};
var _delving$rapid$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mdl: a, snackbar: b, history: c, users: d, services: e, toggles: f, selectedMail: g};
	});

var _delving$rapid$View_Home$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _delving$rapid$View_Home$updatesCard = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Options$css, 'background', 'url(\'images/pomegranate.jpg\') center / cover'),
					_1: {
						ctor: '::',
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _delving$rapid$View_Home$white,
							_1: {
								ctor: '::',
...
var _delving$rapid$View_Home$optionsCard = function (model) {
	var option = F2(
							...
							_1: {
								...
								_1: {
									...
									_0: _debois$elm_mdl$Material_Options$onToggle(
										_delving$rapid$Msg$Toggle(index)),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _delving$rapid$View_Home$toClass = function (options) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		{ctor: '[]'});
};
var _delving$rapid$View_Home$view = function (model) {
	var pieClass = _delving$rapid$View_Home$toClass(
		{
			ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_delving$rapid$Charts$pieChart, '#ACEC00', pieClass),
					_1: {
						ctor: '::',
						_0: A2(_delving$rapid$Charts$pieChart, '#00BBD6', pieClass),
						_1: {
							ctor: '::',
							_0: A2(_delving$rapid$Charts$pieChart, '#BA65C9', pieClass),
							_1: {
								ctor: '::',
								_0: A2(_delving$rapid$Charts$pieChart, '#EF3C79', pieClass),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _delving$rapid$Charts$graph('#00b9d8'),
						_1: {
							ctor: '::',
							_0: _delving$rapid$Charts$graph('#d9006e'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _delving$rapid$View_Home$updatesCard(model),
											_1: {
												ctor: '::',
												_0: A2(
													_debois$elm_mdl$Material_Options$div,
												...
												_1: {
													ctor: '::',
													_0: _delving$rapid$View_Home$optionsCard(model),
													_1: {ctor: '[]'}
												}
											}
										}),
...
var _delving$rapid$View_Users$viewUserRow = F2(
	function (model, user) {
		return A2(
...
var _delving$rapid$View_Users$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_List$ul,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_delving$rapid$View_Users$viewUserRow(model),
			model.users));
};

var _delving$rapid$View_Services$viewServiceRow = F2(
...
var _delving$rapid$View_Services$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_List$ul,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_delving$rapid$View_Services$viewServiceRow(model),
			model.services));
};

var _delving$rapid$View$helpDialog = function (model) {
	return A2(
...
var _delving$rapid$View$viewBody = function (model) {
	var _p0 = A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Maybe$Nothing,
	...
	if (_p0.ctor === 'Just') {
		switch (_p0._0.ctor) {
			case 'Home':
				return _delving$rapid$View_Home$view(model);
			case 'Users':
				return _delving$rapid$View_Users$view(model);
			default:
				return _delving$rapid$View_Services$view(model);
		}
	} else {
		return _elm_lang$html$Html$text('404');
	}
};
var _delving$rapid$View$drawerHeader = function (model) {
	return A3(
		_debois$elm_mdl$Material_Options$styled,
		_elm_lang$html$Html$header,
		{
		...
		},
		{
			...
			_0: A3(
				...
				_elm_lang$html$Html$img,
				{
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$attribute(
						_elm_lang$html$Html_Attributes$src('/img/elm.png')),
					_1: {
						ctor: '::',
										...
										_0: A2(
											_debois$elm_mdl$Material_Menu$item,
											{
												...
												_0: _debois$elm_mdl$Material_Menu$onSelect(
													_delving$rapid$Msg$SelectMail('orgID 0')),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('orgID 0'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_debois$elm_mdl$Material_Menu$item,
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Menu$onSelect(
														_delving$rapid$Msg$SelectMail('orgID 1')),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('orgID 1'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													_debois$elm_mdl$Material_Menu$item,
													{
														ctor: '::',
														_0: _debois$elm_mdl$Material_Menu$onSelect(
															_delving$rapid$Msg$SelectMail('orgID 2')),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('orgID 2'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_debois$elm_mdl$Material_Menu$item,
														{
															ctor: '::',
															_0: _debois$elm_mdl$Material_Menu$onSelect(
																_delving$rapid$Msg$SelectMail('orgID 3')),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('orgID 3'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
...
var _delving$rapid$View$viewDrawerMenuItem = F2(
	function (model, menuItem) {
		...
		var onClickCmd = function () {
			...
			if (((_p2.ctor === '_Tuple2') && (_p2._0 === false)) && (_p2._1.ctor === 'Just')) {
				return _debois$elm_mdl$Material_Options$onClick(
					_delving$rapid$Msg$NewUrl(
						_delving$rapid$Route$urlFor(_p2._1._0)));
			} else {
				return _debois$elm_mdl$Material_Options$nop;
			}
		}();
...
var _delving$rapid$View$menuItems = {
	...
	_1: {
		ctor: '::',
		_0: {text: 'Datasets', iconName: 'folder', route: _elm_lang$core$Maybe$Nothing},
		_1: {
			ctor: '::',
			_0: {
				text: 'Users',
				iconName: 'group',
				route: _elm_lang$core$Maybe$Just(_delving$rapid$Route$Users)
			},
			_1: {
				ctor: '::',
...
var _delving$rapid$View$viewDrawer = function (model) {
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_delving$rapid$View$viewDrawerMenuItem(model),
				_delving$rapid$View$menuItems),
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Layout$spacer,
				_1: {
...
var _delving$rapid$View$viewSource = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_delving$rapid$Msg$Mdl,
		{
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onClick(
															_delving$rapid$Msg$ViewSourceClick('https://github.com/vipentti/elm-mdl-dashboard')),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _delving$rapid$View$viewHeader = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Rapid Dashboard'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _delving$rapid$View$view = function (model) {
	return _debois$elm_mdl$Material_Scheme$top(
		A4(
			...
			},
			{
				header: {
					ctor: '::',
					_0: _delving$rapid$View$viewHeader(model),
					_1: {ctor: '[]'}
				},
				drawer: {
					ctor: '::',
					_0: _delving$rapid$View$drawerHeader(model),
					_1: {
						ctor: '::',
						_0: _delving$rapid$View$viewDrawer(model),
						_1: {ctor: '[]'}
					}
				},
				tabs: {
				...
				main: A2(
					...
					{
						ctor: '::',
						_0: _delving$rapid$View$viewBody(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$map,
								_delving$rapid$Msg$Snackbar,
								_debois$elm_mdl$Material_Snackbar$view(model.snackbar)),
							_1: {
								ctor: '::',
								_0: _delving$rapid$View$helpDialog(model),
								_1: {ctor: '[]'}
							}
						}
					},
					_delving$rapid$Charts$createDefinitions)
			}));
};
var _delving$rapid$View$styles = '\n   .demo-options .mdl-checkbox__box-outline {\n      border-color: rgba(255, 255, 255, 0.89);\n    }\n\n   .mdl-layout__drawer {\n      border: none !important;\n   }\n\n   .mdl-layout__drawer .mdl-navigation__link:hover {\n      background-color: #00BCD4 !important;\n      color: #37474F !important;\n    }\n   ';
var _delving$rapid$View$MenuItem = F3(
	function (a, b, c) {
		return {text: a, iconName: b, route: c};
	});

var _delving$rapid$Ports$windowOpen = _elm_lang$core$Native_Platform.outgoingPort(
	'windowOpen',
	function (v) {
		return v;
	});

var _delving$rapid$Update$mockUser = {name: 'Rapid OrgID 1'};
var _delving$rapid$Update$fetchUsers = function (newModel) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$always(
			_delving$rapid$Msg$GotUsers(
				{ctor: '::', _0: _delving$rapid$Update$mockUser, _1: newModel.users})),
		_elm_lang$core$Task$succeed(
			{ctor: '_Tuple0'}));
};
var _delving$rapid$Update$urlUpdate = F2(
	function (model, route) {
		...
		if ((_p0.ctor === 'Just') && (_p0._0.ctor === 'Users')) {
			return A2(
				...
				{
					ctor: '::',
					_0: _delving$rapid$Update$fetchUsers(newModel),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
...
var _delving$rapid$Update$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _delving$rapid$Msg$Mdl, _p1._0, model);
			case 'Snackbar':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _delving$rapid$Msg$Snackbar, snackCmd),
						_1: {ctor: '[]'}
					});
			case 'NavigateTo':
				return A2(
					_delving$rapid$Update$urlUpdate,
					model,
					_delving$rapid$Route$locFor(_p1._0));
			case 'NewUrl':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
			...
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: _delving$rapid$Ports$windowOpen(_p1._0),
						_1: {ctor: '[]'}
					});
		}
	});

var _delving$rapid$Subscriptions$subscriptions = function (model) {
	return A2(_debois$elm_mdl$Material$subscriptions, _delving$rapid$Msg$Mdl, model);
};

var _delving$rapid$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_delving$rapid$Msg$NavigateTo,
	{init: _delving$rapid$Model$init, update: _delving$rapid$Update$update, view: _delving$rapid$View$view, subscriptions: _delving$rapid$Subscriptions$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _delving$rapid$Main$main !== 'undefined') {
    _delving$rapid$Main$main(Elm['Main'], 'Main', undefined);
}
