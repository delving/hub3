...
viewHeader model =
    Layout.row
        ...
        [ Layout.title [] [ text "Rapid Dashboard" ]
        , Layout.spacer
        , Layout.navigation []
            []
        ]
    ...
    Options.styled Html.header
        ...
        , Options.styled Html.div
            ...
            , Menu.render Mdl
                ...
                [ Menu.item
                    [ Menu.onSelect (SelectMail "orgID 0") ]
                    [ text "orgID 0" ]
                , Menu.item
                    [ Menu.onSelect (SelectMail "orgID 1") ]
                    [ text "orgID 1" ]
                , Menu.item
                    [ Menu.onSelect (SelectMail "orgID 2") ]
                    [ text "orgID 2" ]
                , Menu.item
                    [ Menu.onSelect (SelectMail "orgID 3") ]
                    [ text "orgID 3" ]
                ]
            ]
        ]
