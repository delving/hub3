...
func (*Join) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
type FragmentGraph struct {
	...
	Join          *Join       `protobuf:"bytes,13,opt,name=join" json:"join,omitempty"`
}
...
func (*FragmentGraph) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (m *FragmentGraph) GetJoin() *Join {
	if m != nil {
		return m.Join
	}
	return nil
...
type Fragment struct {
	...
	Join    *Join    `protobuf:"bytes,31,opt,name=join" json:"join,omitempty"`
}

func (m *Fragment) Reset()                    { *m = Fragment{} }
func (m *Fragment) String() string            { return proto.CompactTextString(m) }
func (*Fragment) ProtoMessage()               {}
func (*Fragment) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func init() {
	...
	proto.RegisterType((*Join)(nil), "fragments.Join")
...
var fileDescriptor0 = []byte{
	...
	,
}
