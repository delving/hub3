...
const file_hub3_fragments_viewconfig_proto_rawDesc = "" +
	"\n" +
	"\x1fhub3/fragments/viewconfig.proto\x12\tfragments\x1a\x18hub3/fragments/api.proto\"\xb6\x03\n" +
	"\rDataSetConfig\x12\x0e\n" +
	"\x02ID\x18\v \x01(\tR\x02ID\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x1a\n" +
	"\bmarkdown\x18\x02 \x01(\tR\bmarkdown\x128\n" +
	"\vdataSetType\x18\x03 \x01(\x0e2\x16.fragments.DataSetTypeR\vdataSetType\x12-\n" +
	"\x06facets\x18\x04 \x03(\v2\x15.fragments.FacetFieldR\x06facets\x12\x12\n" +
	"\x04spec\x18\x05 \x03(\tR\x04spec\x12 \n" +
	"\vexcludeSpec\x18\n" +
	" \x03(\tR\vexcludeSpec\x12;\n" +
	"\n" +
	"viewConfig\x18\x06 \x01(\v2\x1b.fragments.DetailViewConfigR\n" +
	"viewConfig\x12?\n" +
	"\fresultConfig\x18\a \x01(\v2\x1b.fragments.ResultViewConfigR\fresultConfig\x120\n" +
	"\x06filter\x18\b \x01(\v2\x18.fragments.DataSetFilterR\x06filter\x12\x14\n" +
	"\x05orgID\x18\t \x01(\tR\x05orgID\"_\n" +
	"\rDataSetFilter\x128\n" +
	"\vqueryFilter\x18\x01 \x03(\v2\x16.fragments.QueryFilterR\vqueryFilter\x12\x14\n" +
	"\x05query\x18\x02 \x01(\tR\x05query\"\x97\x01\n" +
	"\x10ResultViewConfig\x125\n" +
	"\n" +
	"resultType\x18\x01 \x01(\x0e2\x15.fragments.ResultTypeR\n" +
	"resultType\x124\n" +
	"\x06fields\x18\x02 \x01(\v2\x1c.fragments.PresentationFieldR\x06fields\x12\x16\n" +
	"\x06inline\x18\x03 \x01(\bR\x06inline\"\xda\x02\n" +
	"\x11PresentationField\x122\n" +
	"\ti18nLabel\x18\x01 \x01(\v2\x14.fragments.I18NLabelR\ti18nLabel\x12\x1c\n" +
	"\tclickable\x18\x02 \x01(\bR\tclickable\x12\x1e\n" +
	"\n" +
	"searchable\x18\a \x01(\bR\n" +
	"searchable\x12\x1c\n" +
	"\tpredicate\x18\x03 \x01(\tR\tpredicate\x12\x16\n" +
	"\x06single\x18\x04 \x01(\bR\x06single\x12\x14\n" +
	"\x05order\x18\x05 \x01(\x05R\x05order\x122\n" +
	"\tfieldType\x18\x06 \x01(\x0e2\x14.fragments.FieldTypeR\tfieldType\x125\n" +
	"\n" +
	"inlineType\x18\b \x01(\x0e2\x15.fragments.InlineTypeR\n" +
	"inlineType\x12\x1c\n" +
	"\tinlineCSS\x18\t \x01(\tR\tinlineCSS\"`\n" +
	"\x10DetailViewConfig\x12.\n" +
	"\x06blocks\x18\x01 \x03(\v2\x16.fragments.DetailBlockR\x06blocks\x12\x1c\n" +
	"\tentryType\x18\x02 \x01(\tR\tentryType\"3\n" +
	"\tI18NLabel\x12\x12\n" +
	"\x04lang\x18\x01 \x01(\tR\x04lang\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\xf5\x01\n" +
	"\vDetailBlock\x122\n" +
	"\ti18nLabel\x18\x01 \x01(\v2\x14.fragments.I18NLabelR\ti18nLabel\x12$\n" +
	"\rresourceLabel\x18\x02 \x01(\tR\rresourceLabel\x12\x14\n" +
	"\x05order\x18\x03 \x01(\x05R\x05order\x12\"\n" +
	"\fresourceType\x18\x04 \x01(\tR\fresourceType\x124\n" +
	"\x06fields\x18\x05 \x03(\v2\x1c.fragments.PresentationFieldR\x06fields\x12\x1c\n" +
	"\tinlineCSS\x18\x06 \x01(\tR\tinlineCSS*4\n" +
	"\vDataSetType\x12\n" +
	"\n" +
	"\x06SINGLE\x10\x00\x12\f\n" +
	"\bMULTIPLE\x10\x01\x12\v\n" +
	"\aBYQUERY\x10\x02*7\n" +
	"\n" +
	"ResultType\x12\b\n" +
	"\x04GRID\x10\x00\x12\t\n" +
	"\x05TABLE\x10\x01\x12\a\n" +
	"\x03MAP\x10\x02\x12\v\n" +
	"\aARCHIVE\x10\x03*]\n" +
	"\tFieldType\x12\v\n" +
	"\aLITERAL\x10\x00\x12\f\n" +
	"\bRESOURCE\x10\x01\x12\b\n" +
	"\x04DATE\x10\x02\x12\t\n" +
	"\x05POINT\x10\x03\x12\x12\n" +
	"\x0eDIGITAL_OBJECT\x10\x04\x12\f\n" +
	"\bMANIFEST\x10\x05*S\n" +
	"\n" +
	"InlineType\x12\b\n" +
	"\x04NONE\x10\x00\x12\f\n" +
	"\bURI_ONLY\x10\x04\x12\t\n" +
	"\x05LABEL\x10\x01\x12\t\n" +
	"\x05MODAL\x10\x02\x12\x17\n" +
	"\x13INLINE_DETAIL_BLOCK\x10\x03B\x10Z\x0ehub3/fragmentsb\x06proto3"

var (
	file_hub3_fragments_viewconfig_proto_rawDescOnce sync.Once
	file_hub3_fragments_viewconfig_proto_rawDescData []byte
)

func file_hub3_fragments_viewconfig_proto_rawDescGZIP() []byte {
	file_hub3_fragments_viewconfig_proto_rawDescOnce.Do(func() {
		file_hub3_fragments_viewconfig_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_hub3_fragments_viewconfig_proto_rawDesc), len(file_hub3_fragments_viewconfig_proto_rawDesc)))
	})
...
var file_hub3_fragments_viewconfig_proto_goTypes = []any{
...
func file_hub3_fragments_viewconfig_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_hub3_fragments_viewconfig_proto_rawDesc), len(file_hub3_fragments_viewconfig_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
