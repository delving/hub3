...
type SearchRequest struct {
	...
	FacetSort         string         `protobuf:"bytes,49,opt,name=facetSort,proto3" json:"facetSort,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SearchRequest) GetFacetSort() string {
	if x != nil {
		return x.FacetSort
	}
	return ""
...
type FragmentEntryDoc struct {
	...
	// SortValue mirrors ikuzo.domain.domainpb.Entry.sortValue — carries
	// an alternate key (e.g. surname-first form) so facet aggregations
	// can order buckets on it while Value stays the visible key.
	SortValue     string `protobuf:"bytes,11,opt,name=sortValue,proto3" json:"sortValue,omitempty"` // Content Index
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FragmentEntryDoc) GetSortValue() string {
	if x != nil {
		return x.SortValue
	}
	return ""
...
const file_hub3_fragments_api_proto_rawDesc = "" +
	...
	"withFields\x12\x14\n" +
	"\x05orgID\x18\x17 \x01(\tR\x05orgID\"\xe0\r\n" +
	...
	"\tfacetFull\x180 \x01(\tR\tfacetFull\x12\x1c\n" +
	"\tfacetSort\x181 \x01(\tR\tfacetSort\"\xe1\x02\n" +
	...
	"Predicates\x12@\n" +
	"\tObjectIDs\x18\a \x03(\v2\".fragments.FragmentReferrerContextR\tObjectIDs\"\xd0\x02\n" +
	...
	"\tsortValue\x18\v \x01(\tR\tsortValue\"\xa5\x03\n" +
