...
type Header struct {
	...
	RecDefID     string `protobuf:"bytes,13,opt,name=RecDefID,proto3" json:"-"`
	AboutTypeURI string `protobuf:"bytes,14,opt,name=AboutTypeURI,proto3" json:"-"`
}
...
var file_hub3_fragments_api_proto_rawDesc = []byte{
	...
	0x54, 0x79, 0x70, 0x65, 0x55, 0x52, 0x49, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x41,
